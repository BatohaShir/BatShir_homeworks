...
export function ProductCard() {
  ...
  // const { menu, getData, Loading } = useMenu();
                  ...
                  .map((item, itemIndex) => (
                    <div key={itemIndex} className="flex">
                      ...
                      <div className="inline-block overflow-hidden rounded-md">
                        <img src={item.image} alt="" className="w-[150px] h-[150px] shrink-0 object-cover mr-[1.5em] rounded-md transition-[1s] hover:scale-[1.2] hover:rounded-md shadow-lg shadow-black" />
                      </div>
                      </a>
